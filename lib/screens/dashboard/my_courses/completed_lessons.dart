...
import 'package:telead_e_learning/widgets/custom_search_bar.dart';

import '../../../controllers/dashboard/my_courses/completed_lessons_controller.dart';
import '../../../widgets/custom_button.dart';


class CompletedLessons extends StatelessWidget {
  CompletedLessons({super.key});

  final List<CourseSection> courseSections = CourseData.generateDummyData();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CompletedLessonsController>(
        init: CompletedLessonsController(),
        builder: (controller) {
          return Scaffold(
